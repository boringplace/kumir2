#include "arduinocompilertoolplugin.h"
...
using namespace ArduinoCompilerTool;
using namespace KumirAnalizer;

typedef Shared::GeneratorInterface::DebugLevel DebugLevel;

ArduinoCompilerToolPlugin::ArduinoCompilerToolPlugin()
    : KPlugin()
    , analizer_(nullptr)
    , generator_(nullptr)
...
ArduinoCompilerToolPlugin::acceptableCommandLineParameters() const
{
...
QString ArduinoCompilerToolPlugin::initialize(
...
void ArduinoCompilerToolPlugin::start()
{
...
void ArduinoCompilerToolPlugin::stop()
{

}

void ArduinoCompilerToolPlugin::createPluginSpec()
{
    _pluginSpec.name = "ArduinoCompilerTool";
...
Q_EXPORT_PLUGIN(ArduinoCompilerToolPlugin)
#endif
